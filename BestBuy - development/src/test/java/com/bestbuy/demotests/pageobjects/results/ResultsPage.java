...
public class ResultsPage extends Page {
  ...
  @FindBy(xpath  = "//span[@class='materialOverride_STCNx toolbarTitle_2lgWp']")
  private HtmlElement totalCountElement;
  
  private final String resultsPageError = "results page is not displayed";
  private final String expectedUrl = "search";
  ...
  public DetailsPage selectResult(int index) {	 	 
	 SearchResult result = getOnlineResults().get(index);
	     System.out.println("result is after filter:"+result.getText());
	 result.click();
  ...
  public int totalCount() {
	    ...
	    String value=totalCountElement.getText();
