...
public class TestClass extends com.bestbuy.demotests.BaseTest.BaseTestClass{
	...
	public void transactionFailsForIncorrectPaymentInfo(String keyword) { 	
		...
		ResultsPage resultsPage = homePage.open()
				                          .search(keyword);
		//resultsPage.selectOffer("As Advertised");
		//resultsPage.selectOffer("Online Only");
		//resultsPage.selectResult(0);
	
		
		//DetailsPage detailsPage = resultsPage.selectOffer("Online Only").selectResult(5);
